...
" Ignore case when searching with only lowercase characters
set ignorecase
set smartcase
...
" <c-i> is tab, so change next/prev jumplist maps
nnoremap <c-o> <c-i>
nnoremap <c-p> <c-o>
...
" Useful mappings for managing windows and tabs
...
" F10 to identify syntax highlight group used at cursor
