---
name: confluence
description: "Fetch and summarize Confluence pages. Use for: confluence page, confluence URL, read confluence, summarize confluence, confluence search."
tools: Read, Bash, Grep
---

<!-- Claude Code adaptation of .agents/skills/confluence/SKILL.md -->
<!-- Keep in sync: changes here may need mirroring to the Copilot version and vice versa -->

# Confluence Query

> **Why this agent exists:** The Atlassian MCP server does not work reliably for
> Confluence (auth/VPN issues). Always use this curl-based agent for Confluence
...
- A full Confluence URL (e.g., `https://REDACTED/display/SPACE/Page+Title` or `.../pages/123456/...`)
- A page ID
...
`CONFLUENCE_URL` and `CONFLUENCE_PERSONAL_TOKEN` are available as environment variables.
